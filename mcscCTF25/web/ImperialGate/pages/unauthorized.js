...
export default function Unauthorized() {
  ...
  return (
    <div className={styles.unauthorizedPage}>
      <Head>
        <title>Imperial Gate | Access Forbidden</title>
      ...
      <div className={styles.unauthorizedContainer}>
        ...
        <h1 className={styles.unauthorizedTitle}>You are not yet worthy</h1>

        <div className={styles.unauthorizedMessage}>
          <p>
            Trespass further, and your name will be struck from the scrolls of
            history. <br /> None but the Emperor himself may cross this
            threshold. Return to the gate or face the eternal wrath of the
            Empire.
          </p>
        </div>

        <Link href="/" className={styles.gateButton}>
